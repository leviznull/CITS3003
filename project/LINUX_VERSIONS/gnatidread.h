...
// [PART 2][D]
// Increased the number of meshes
...
// [PART 2][D]
// Added new mesh entries in the menu
char objectMenuEntries[numMeshes][128] = {
    ...
    "51 Chef", "52 Parasaurolophus", "53 Rooster", "54 T-rex", "55 Sphere", "56 Base Model",
    "57 (Added) Male", "58 (Added) Female", "59 (Added) Anime"};
// [END]
